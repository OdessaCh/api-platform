 ...
 */
final class Version20220915085808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT NOT NULL, hackaton_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, start_date DATE DEFAULT NULL, reward TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE document ALTER hackaton_id SET NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ALTER hackaton_id DROP NOT NULL');
    }
}
